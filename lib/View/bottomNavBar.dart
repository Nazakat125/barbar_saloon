  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar:BottomNavigationBar(
          ...
          selectedItemColor: Colors.black, // Change the selected label text color
          unselectedItemColor: Colors.grey,
          items:[
            BottomNavigationBarItem(icon: Icon(Icons.home,color: Colors.grey,),label: 'Home'),
            BottomNavigationBarItem(icon: Icon(Icons.location_on,color: Colors.grey,),label: 'Location'),
            BottomNavigationBarItem(icon: Icon(Icons.file_present,color: Colors.grey,),label: 'Booking'),
